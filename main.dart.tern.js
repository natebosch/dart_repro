// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.3.0-edge.d239b906e96053ece3ca7e2b241296cf177edc96.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    hmm(f, $T) {
      return $T._eval$1("Future<0>")._is(f) ? f : A.Future_Future$value(f, $T);
    },
    main() {
      var t1 = type$.int,
        t2 = type$.void;
      A.hmm(1, t1).then$1$1(A.core__print$closure(), t2);
      A.hmm(A.Future_Future$value(1, t1), t1).then$1$1(A.core__print$closure(), t2);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "core__print$closure", "print", 7);
  })();
  (function inheritance() {
    var _inherit = hunkHelpers.inherit,
      _inheritMany = hunkHelpers.inheritMany;
    _inherit(A.Object, null);
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._Zone, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure]);
